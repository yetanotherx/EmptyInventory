...
/*
 * EmptyInventory Version 1.1 - Empty your inventory
...
public class EmptyInventory extends JavaPlugin {
            ...
            if (commandName.equals("empty")) {
                ...
                if (this.hasPermission(player)) {
                    ...
                    if (split.length == 1 && split[0].equalsIgnoreCase("-all")) {
                        ...
                        player.sendMessage(ChatColor.AQUA + "Your inventory and hotbar are now cleared.");
                        ...
                        player.sendMessage(ChatColor.AQUA + "Your inventory is now cleared.");
    ...
    private boolean hasPermission(Player player) {
        if (Permissions != null) {
            return Permissions.has(player, "emptyinventory.use");
        } else {
            return player.isOp();
        }
    }
